...
InstanceOf: Bundle
Title: "Hematology studies as FHIR Document example"
Description: "Hematology studies example as FHIR document (copy-paste the URL if the link on the left does not work)    https://build.fhir.org/ig/hl7-be/hl7-be-fhir-laboratory-report/Bundle-hematologyStudiesAsFHIRDocument.html"
Usage: #definition
...
* entry[=].resource = Inline-Instance-for-hematologyStudiesAsFHIRDocument-1
* entry[+].fullUrl = "urn:uuid:7c16c9c0-c471-4098-ae18-48abcadd8d34"
* entry[=].resource = diagnosticreport1
...
* entry[=].resource = Inline-Instance-for-hematologyStudiesAsFHIRDocument-12
